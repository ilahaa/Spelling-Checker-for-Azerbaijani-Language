...
const Footer = () => {
  ...
  <div className="container">
        ...
        <div className="layout">
          <div className="layout_item w-50">
            <div className="newsletter">
              ...
              Doğru-düzgün sizə yüksək keyfiyyətli və professional məzmun yaratmaqda kömək edir.
              </h3>
            </div>
          </div>
          ...
          <div className="layout_item w-25">
            <nav className="c-nav-tool">
              ...
              <ul className="c-nav-tool_list">
                ...
                <li className="c-nav-tool_item">
                  <a href="/pages/contact" className="c-link">
                    Contact
                  </a>
                </li>
              </ul>
    ...
    <div className="footer_copyright">
      <p>© 2024 Software. Bütün hüquqlar qorunur.</p>
    </div>
  </div>
</footer>
